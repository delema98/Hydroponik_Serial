...
float DFRobot_EC10::calcEC(float voltage, float temperature)
{
  float value = 0;
...
int DFRobot_EC10::SerialCalibration(float voltage, float temperature) //Aufruf der Kalibrierung von RPi, keine mehreren Modi
{
  this->_voltage = voltage;
  this->_temperature = temperature;

  //schauen ob der Sensor sich in der Kalibrierflüssigkeit befindet
